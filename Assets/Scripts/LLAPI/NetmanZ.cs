...
public class NetmanZ : MonoBehaviour {

	public int mServerSocket = -1;
	public int mClientSocket = -1;
	public int mClientConnection = -1;
	public int mMaxConnections = 10;
	byte mChannelUnreliable;
	byte mChannelReliable;
	public bool mHostClientInitialized = false;
	public bool mClientConnected = false;
